...
export class MethodologyLoader {
    ...
    schemaPath;
    cache = new Map();
    constructor(methodologyDir = join(process.cwd(), 'methodology'), schemaPath = join(process.cwd(), 'methodology', 'schemas', 'skill-definition.schema.json')) {
...
// Singleton instance
let loader = null;
export function getMethodologyLoader() {
    if (!loader) {
