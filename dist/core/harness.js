 ...
 */
import { getMethodologyLoader } from './methodology.js';
...
export class Harness {
     ...
     */
    buildSystemPrompt(skill, context) {
...
${skill.outputs.format === 'structured' && skill.outputs.schema
     ...
     * Execute a tool call
     */
    async executeToolCall(toolCall, allowedTools, context) {
        // Find the tool
